...
| `atow.special.planetary-conditions` | Special Case Rules | Planetary conditions, movement modifiers, terrain, weather, exotic conditions, and gravity. | 232-240 | 230-238 | Modifier/table heavy. | `rules/special/planetary-conditions.md` | `special.planetary-conditions` | needs source review |
| `atow.special.creatures` | Special Case Rules | Creature encounters, attributes, skills, combat, compendium entries, and creature table. | 240-247 | 238-245 | Catalog/table heavy. | `rules/special/creatures.md` | `special.creatures` | needs source review |
| `atow.special.diseases` | Special Case Rules | Disease medical maintenance and random disease effects. | 247-251 | 245-249 | Table-heavy. | `rules/special/diseases.md` | `special.diseases` | needs source review |
...
| `atow.gm.advancement` | Gamemastering Guide | Rewards, character advancement, aging, attributes, traits, skills, training, downtime, wealth/property, and rank/power. | 332-338 | 330-336 | Tables and campaign procedures; do not reproduce tables. | `rules/campaign/advancement-and-rewards.md` | `campaign.advancement-rewards` | needs source review |

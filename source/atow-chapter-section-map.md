...
| `atow.equipment.battle-armor-exoskeletons` | Equipment | Battle armor, exoskeletons, and related special game rules. | 300-302 | 298-300 | Source reviewed in issue `#93`; exact suit stats and tactical rules remain private source/tool lookup. | `rules/equipment/battle-armor-and-exoskeletons.md` | `equipment.battle-armor-exoskeletons` | source reviewed |
...
| `atow.equipment.prosthetics-implants` | Equipment | Prosthetics, limb/organ replacements, elective implants, and related special rules. | 316-320 | 314-318 | Source reviewed in issue `#93`; exact tables, values, surgery modifiers, and implant effects remain private lookup. | `rules/equipment/prosthetics-and-implants.md` | `equipment.prosthetics-implants` | source reviewed |
| `atow.equipment.drugs-poisons` | Equipment | Drugs, poisons, and related special rules. | 319-323 | 317-321 | Source reviewed in issue `#93`; exact drug, poison, treatment, addiction, and creation table values remain private lookup. | `rules/equipment/drugs-and-poisons.md` | `equipment.drugs-poisons` | source reviewed |
| `atow.equipment.personal-vehicles-fuel` | Equipment | Personal vehicles, fuel, and equipment-section continuation before the next fiction bridge. | 323-327 | 321-325 | Source reviewed in issue `#93`; exact vehicle catalog, fuel, and tactical unit values remain private source/tool lookup. | `rules/equipment/personal-vehicles.md` | `equipment.personal-vehicles` | source reviewed |

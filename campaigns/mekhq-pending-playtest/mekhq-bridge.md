...
- Bootstrap source summary: `C:\Users\waltr\AppData\Local\Temp\mekhq-pending-playtest-summary.json`
- Bootstrap timestamp: `2026-06-21T14:06:47.243626+00:00`
- Summary helper: `summarize-mekhq-save.py` version `0.1.0`
- Source save path: `C:\Users\waltr\Documents\megamek-workspace\external\installs\MekHQ-0.51.00\campaigns\mek-rpg-test.cpnx`
- Source save timestamp: `2026-06-21T14:04:59.329134+00:00`
- Summary import timestamp: `2026-06-21T14:06:46.581152+00:00`
- MekHQ save version: `0.51.00`
- Gzip compressed source: `False`

## Latest Re-Import Metadata

- Re-import reason: issue `#37` manual one-day MekHQ advancement validation
- Source save path: `C:\Users\waltr\Documents\megamek-workspace\external\installs\MekHQ-0.51.00\campaigns\mek-rpg-test.cpnx`
- Source save timestamp: `2026-06-21T14:07:54.648867+00:00`
- Summary import timestamp: `2026-06-21T14:08:14.746917+00:00`
- MekHQ save version: `0.51.00`
- Gzip compressed source: `False`
...
- Location: Astrokaszy
- Funds: 95669054 CSB
- Viewpoint: Lazarus Olinger (`64975645-037a-4ac0-b6bb-0ffe7d25db63`), Selected first MekHQ commander flag.
...
- Personnel market applicants: 6
- Contract market offers: 0

## Cross-References

### Personnel

- `fd15b53b-14fa-4c36-ae9a-111c3ccd27ec` -> `michelle-moreno-double-m`: Michelle Moreno "Double-M"
- `085a1bb4-dba8-47ed-8bfb-c0b5fc625db1` -> `martin-ito`: Martin Ito
...
- `e5139ba9-fa78-4040-9549-f451b96c004f` -> `flatbed-truck`: Flatbed Truck
- `c6573efc-e2d9-47fa-af94-15aec6de80c6` -> `flatbed-truck`: Flatbed Truck
- `0297b4dd-1326-438a-9e6d-6e47c418cac1` -> `scorpion-light-tank`: Scorpion Light Tank
- `ea9e5925-3b2c-416e-93d4-18119848642b` -> `scorpion-light-tank`: Scorpion Light Tank
- `5ed3790f-5bb9-4adf-8849-f17794bd7cd7` -> `foot-squad-rifle`: Foot Squad (Rifle)
- `cc18d328-9fa4-4c7d-bae8-c0ef2583a745` -> `leopard-2537`: Leopard (2537)
...
- `eb6d60a7-d9ac-4f08-b1fc-af447f1c6ca8` -> `stalker-stk-4p`: Stalker STK-4P
...
- unit_market_final_prices: Serialized offers include percent and unit name; final price requires MekHQ unit cost lookup and campaign multipliers. (Unsupported)
- exact_unit_damage_state: Prototype reports linked parts and maintenance text but does not translate MekHQ entity locations, armor, internals, or critical slots. (Unsupported)
- transport_capacity_and_cargo_pressure: Top-level location and unit sections are read, but transport-capacity semantics are not mapped yet. (Needs MekHQ inspection)
- daily_report_alerts: Report fields can contain presentation HTML; prototype does not classify them into finance, medical, repair, or logistics alerts. (Unsupported)
...
- Issue `#37` resolved `mekhq-pending-2026-06-21-001`: user advanced MekHQ one day in the UI, saved, and a read-only re-import confirmed date `3025-07-25`.

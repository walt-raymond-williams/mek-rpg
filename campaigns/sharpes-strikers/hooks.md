...
- Market inspection: Heavy BattleMech Recovery Vehicle; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: BattleMech Recovery Vehicle; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: BattleMech Recovery Vehicle; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Heavy BattleMech Recovery Vehicle; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Prime Mover (Succession Wars); final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Buffalo BFFL Hovertruck; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Heavy BattleMech Recovery Vehicle; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Goblin Medium Tank; final price and selectors are unsupported until checked in MekHQ.
- Market inspection: Flatbed Truck (Armor); final price and selectors are unsupported until checked in MekHQ.
- Hiring interview: Bob Nurmela, role `Medic`.
- Hiring interview: Rory Qiu, role `MekTech`.
- Hiring interview: Aaron Tresidder, role `Vehicle Crew/Ground`.
- Hiring interview: Jens Sanger, role `MekWarrior`.
- Hiring interview: Paulina Buruffski, role `Vehicle Crew/Ground`.
- Hiring interview: Josh Ly, role `Mechanic`.
- Hiring interview: Yuvenaliy Neratov, role `Soldier`.
- Hiring interview: Anne-Kathryn Tarnavean, role `Mechanic`.
- Hiring interview: Conz Sumague, role `Vehicle Crew/Ground`.
- Hiring interview: Donna Quick, role `Soldier`.
- Contract review: Unknown, employer `Federated Suns`.
- Contract review: Unknown, employer `Free Worlds League`.
- Contract review: Unknown, employer `Federated Suns`.
- Contract review: Unknown, employer `Free Worlds League`.
- Contract review: Unknown, employer `Free Worlds League`.
- Contract review: Unknown, employer `Federated Suns`.
- Contract review: Unknown, employer `St. Ives Compact`.
- Contract review: Unknown, employer `St. Ives Compact`.
- Market posture: display-only `true`, automation-ready `false`, unit offers `50`, personnel applicants `122`, contract offers `8`.
- Shopping pressure: shopping list item count: 0; total buy cost: 0 C-Bill.
- Report pressure: current: 4; skill: 1; technical: 2; finances: 1; acquisitions: 1; medical: 1; personnel: 2; battle: 1; politics: 1; aggregate: 1.

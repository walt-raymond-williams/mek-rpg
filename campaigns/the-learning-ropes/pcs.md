...
- MekHQ role/rank: MEKWARRIOR / 34 (Confirmed from MekHQ import)
- MekHQ assignment: unit id `4653009b-0108-465c-bad3-cc19c3cb742c`
- Current location: See `current-state.md`
- Current condition: MekHQ availability `ACTIVE`; A Time of War condition TBD.

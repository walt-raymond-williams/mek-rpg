...
$validationReports = @{
    ...
    "equipment" = @("docs/current/DRAFT_COVERAGE_AND_HELPER_VALIDATION.md", "docs/current/SPECIAL_EQUIPMENT_SOURCE_REVIEW_VALIDATION.md")
    ...
    "special-case-rules" = @("docs/current/SPECIAL_CASE_RULES_SOURCE_REVIEW_VALIDATION.md")

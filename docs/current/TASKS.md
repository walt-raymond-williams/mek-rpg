...
- Issue `#41`: add `bootstrap-mekhq-campaign.py` unit-style fixture coverage, with active handoff `docs/handoffs/active/add-bootstrap-mekhq-campaign-unit-fixture-coverage.md`, and add it to `scripts/test-all.ps1`.

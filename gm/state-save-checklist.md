...
1. Update `current-state.md` with the exact resume point, current location, immediate pressure, current party, and next prompt.
2. Update `session-log.md` with active or most recent session notes: concise summary, important rolls, rulings, consequences, rewards, costs, and next-session prompts.
